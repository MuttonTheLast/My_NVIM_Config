...
-- NOTE: Quick Fix
vim.keymap.set({"n", "v"}, "<leader>.", vim.lsp.buf.code_action, { noremap = true, silent = true , desc="Line quick fix menu"})
vim.keymap.set("n", "<leader><C-.>", "<cmd>Telescope diagnostics<CR>", {noremap=true, silent=true, desc="Telescope quick fix"})
